...
plot_scope(simuResult, 'deltaF', 'Time [s]', '\Delta f [Hz]', 'Part 1: Frequency deviation', 'part1c_freq.png');

%% q1d - Powers

plot_multiple_scopes(simuResult, {'Pm1','Pm2'}, 'Time [s]', '\Delta P_m [MW]', 'Part 1d: Mechanical powers', 'part1d_powers.png', true);
...
plot_scope(simuResult, 'deltaF', 'Time [s]', '\Delta f [Hz]', 'Part 1(e): Frequency with 1 MW/s limit on Gen 1', 'part1e_freq.png');
...
tune_k = 0.25; % other values have been used for testing
simuFile = 'q2';
load_system(simuFile);
set_param(simuFile, 'StopTime', '1000');

% run simulation
simuResult = sim(simuFile);

% plot requency
plot_scope(simuResult, 'deltaF', 'Time [s]', '\Delta f [Hz]', 'Part 2: Frequency with AGC', 'part2_freq.png');
...
plot_scope(simuResult, 'deltaF', 'Time [s]', '\Delta f [Hz]', 'Part 3: Frequency with lower M and D', 'part3_freq.png');

%% q3 - Powers

plot_multiple_scopes(simuResult, {'Pm1','Pm2','POverall'}, 'Time [s]', '\Delta P_m [MW]', 'Part 3: Mechanical powers', 'part3_powers.png', true);
