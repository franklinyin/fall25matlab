...
plot_multiple_scopes(simuResult, {'deltaF'}, 'Time [s]', '\Delta f [Hz]', 'Q1c: Frequency deviation', 'part1c_freq.png');
...
% q1e plot requency
plot_multiple_scopes(simuResult, {'deltaF'}, 'Time [s]', '\Delta f [Hz]', 'Q1e: Frequency with 1 MW/s limit on Gen 1', 'part1e_freq.png');
...
% plot frequency
plot_multiple_scopes(simuResult, {'deltaF'}, 'Time [s]', '\Delta f [Hz]', 'Q2: Frequency with AGC', 'part2_freq.png');
...
% q3 plot requency
plot_multiple_scopes(simuResult, {'deltaF'}, 'Time [s]', '\Delta f [Hz]', 'Q3: Frequency with lower M and D', 'part3_freq.png');
...
% plot tie Line Power
plot_multiple_scopes(simuResult, {'Ptie'}, 'Time [s]', 'P_{tie} [MW]', 'Q4: Tie line power', 'part4_tieline.png');
...
% plot tie Line Power
plot_multiple_scopes(simuResult, {'PTieLine'}, 'Time [s]', 'P_{tie} [MW]', 'Q4: Tie line power', 'part4_tieline.png');
